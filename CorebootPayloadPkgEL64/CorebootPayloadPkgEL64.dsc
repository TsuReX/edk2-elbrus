...
[Defines]
	...
	PLATFORM_NAME				=	CorebootPayloadPkgEL64
	...
	OUTPUT_DIRECTORY			=	Build/CorebootPayloadPkgEL64
...
#	SEC Core
#################################
	CorebootModulePkgEL64/SecCore/SecCore.inf
...
#			SortLib				|	MdeModulePkg/Library/UefiSortLib/UefiSortLib.inf
#	} #ShellPkg/Application/Shell/Shell.inf
#!endif #!if $(SHELL_TYPE) == BUILD_SHELL
